...
- Item system: Weapons, potions, and armor can be looted from the ground, managed in an inventory, and equipped/used. Player stats and combat reflect equipped items. (Chests are an upcoming feature). **[Largely Implemented]**
